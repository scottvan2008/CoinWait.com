...
const Tabs = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Root> & { swipeable?: boolean }
>(({ swipeable = true, ...props }, ref) => {
  ...
  const swipeHandlers = useSwipeableTabs(props.value, props.onValueChange, tabValues)

  return <TabsPrimitive.Root ref={ref} {...props} {...(swipeable ? swipeHandlers : {})} />
})
