...
function calculateHalvingProgress(
    lastHalvingTime: string,
        ...
        <section className="mb-12 mt-4">
            <Card variant="bitcoin" className="w-full max-w-4xl mx-auto">
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="grid grid-cols-4 gap-4 md:gap-8 text-center px-2 md:px-8">
                        {[
                            ...
                            <div key={index} className="flex flex-col">
                                ...
                                <span className="bitcoin-countdown-label-large dark:text-gray-300">
                                    {item.label}
                                </span>
                            </div>
                        ))}
                    ...
                    {blockData && (
                        <div className="bg-bitcoin-background dark:bg-gray-800 rounded-lg p-4 md:p-6 mx-2 md:mx-8">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2">
                                    <Calendar className="h-5 w-5 text-bitcoin" />
                                    <span className="text-sm md:text-base font-medium dark:text-gray-300">
                                        Halving Progress
                                    </span>
                                </div>
                                <span className="text-sm md:text-base font-bold text-bitcoin dark:text-blue-400">
                                    {calculateHalvingProgress(
                                        blockData.last_halving_time,
                                        blockData.estimated_halving_time
                                    )}
                                    %
                                </span>
                            ...
                            <Progress
                                variant="bitcoin"
                                value={calculateHalvingProgress(
                                    blockData.last_halving_time,
                                    blockData.estimated_halving_time
                                )}
                                className="h-3 mb-3"
