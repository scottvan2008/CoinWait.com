    ...
    <section className="mb-12">
      ...
      <div className="w-full max-w-4xl mx-auto space-y-8">
        ...
        <Card variant="bitcoin">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl text-bitcoin-dark dark:text-white flex items-center">
              <Coins className="h-5 w-5 mr-2 text-bitcoin" />
              Bitcoin Supply
            </CardTitle>
          </CardHeader>
        ...
        <Card variant="bitcoin">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl text-bitcoin-dark dark:text-white flex items-center">
              <DollarSign className="h-5 w-5 mr-2 text-bitcoin" />
              Market Information
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
        ...
        <Card variant="bitcoin">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl text-bitcoin-dark dark:text-white flex items-center">
              <Pickaxe className="h-5 w-5 mr-2 text-bitcoin" />
              Mining Information
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
        ...
        <Card variant="bitcoin">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl text-bitcoin-dark dark:text-white flex items-center">
              <Globe className="h-5 w-5 mr-2 text-bitcoin" />
              Network Information
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
