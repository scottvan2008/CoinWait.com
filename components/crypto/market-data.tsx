...
export function CryptoMarketData() {
    ...
    const getFilteredCoins = () => {
        ...
        switch (activeTab) {
            ...
            case "stablecoins":
                return marketData.coins.filter((coin) =>
                    [
                        "tether",
                        "usd-coin",
                        "usds",
    ...
    const handlePageChange = (page: number) => {
        ...
        document
            .getElementById("crypto-table-top")
                ...
                <CardContent>
                    ...
                    >
                        ...
                        <div id="crypto-table-top" className="overflow-x-auto">
                            <table
                                className={`w-full ${
                                    isMobile ? "min-w-[320px]" : "min-w-[640px]"
                                } table-auto ${isMobile ? "text-sm" : ""}`}
                            >
                                <thead>
                                    <tr className="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <th
                                            className={`${
                                                isMobile ? "px-1" : "px-4"
                                            } py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider`}
                                        >
                                            Price
                                        </th>
                                        <th
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                    {currentPageCoins.map((coin) => (
                                        <tr
                                            ...
                                            onClick={(e) =>
                                                handleCoinClick(e, coin)
                                            }
                                        >
                                            <td
                                                className={`${
                                                    isMobile ? "px-1" : "px-4"
                                                } py-3 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400`}
                                            >
                                            ...
                                            <td
                                                className={`${
                                                    isMobile ? "px-1" : "px-4"
                                                } py-3 whitespace-nowrap text-sm text-right`}
                                            >
                                                <div
                        ...
                        {totalPages > 1 && (
                            <div className="mt-6">
                                ...
                                <div className="text-center text-sm text-muted-foreground mt-2">
                                    Showing{" "}
                                    {(currentPage - 1) * COINS_PER_PAGE + 1}-
                                    {Math.min(
