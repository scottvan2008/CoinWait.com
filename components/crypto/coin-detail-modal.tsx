...
import { formatCurrency, formatNumber, formatDate, formatShortDate } from "@/lib/formatters"
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 p-3 sm:p-4 bg-bitcoin-background dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-sm font-medium">{formatCurrency(coin.low_24h)}</span>
                    ...
                    <span className="text-sm font-medium">{formatCurrency(coin.high_24h)}</span>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2 p-4 bg-bitcoin-background dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="mt-2 text-center">
                    <div className="text-xs text-muted-foreground">Current: {formatCurrency(coin.current_price)}</div>
            ...
            <TabsContent value="details" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bitcoin-stat-card">
                  ...
                  <div className="text-sm font-medium mt-1">Price: {formatCurrency(coin.atl)}</div>
                ...
                <div className="bitcoin-stat-card">
                  ...
                  <div className="text-sm font-medium mt-1">Price: {formatCurrency(coin.ath)}</div>
                  <div
                    className={`text-xs ${
                      coin.ath_change_percentage > 0
                        ? "text-green-600 dark:text-green-400"
